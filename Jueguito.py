...
input('Así que aquí os voy a dar a elegir de qué fandom queréis que juguemos. Ah, lo que vereís entre paréntesis es el número de personajes que tiene cada uno, debería ser multiplo de 3... En caso de no serlo echadle la culpa al Christian del pasado, no al majo ese que tenéis al lado.')
print("")
print('+-------------------------------------------+')
...
if conjunto == 1:
    nombres = Helluva_Boss
    bolsita = 'Helluva'
elif conjunto == 2:
    nombres = Hazbin_Hotel
    bolsita = 'Aitor empiézate la segunda'
elif conjunto == 3:
    nombres = Helluva_Boss + Hazbin_Hotel
    bolsita = 'El Helluvaverso'
elif conjunto == 4:
    nombres = The_Owl_House
    bolsita = 'La casa Hooty'
elif conjunto == 5:
    nombres = Helluva_Boss + Hazbin_Hotel + The_Owl_House
    ...
    nombres = One_Piece + Naruto + Clásicos
    bolsita = 'Se dijo sí al anime'
elif conjunto == 11:
    nombres = Helluva_Boss + Hazbin_Hotel + The_Owl_House + One_Piece + Naruto + Clásicos + Libros
...
#Esto tengo que quitarlo, es para ver que todo está bien
#print(len(nombres))

seguro = input('Habéis elegido la bolsita: ' + bolsita + '. Estáis seguros? [Y/N] ')

if not seguro == 'Y' or seguro == 'y':
    nombres = 0

if secreto == 0:
    pass
elif secreto == 1:
    nombres = Assasination_Classroom
elif secreto == 2:
    nombres = Black_Clover
elif secreto == 3:
    nombres = Bleach
elif secreto == 4:
    nombres = Jujutsu_Kaisen
elif secreto == 5:
    nombres = My_Hero_Academia
elif secreto == 6:
    nombres = Danganronpa2
    print('')
